    ...
    <>
      ...
      <div className="px-16 flex flex-col gap-10">
        ...
        <div className="flex items-center gap-6">
          <Image className="w-full aspect-auto rounded-2xl" src="/images/banner_1.webp" width="630" height="200" alt="Banner" />
          <Image className="w-full aspect-auto rounded-2xl" src="/images/banner_2.webp" width="630" height="200" alt="Banner" />
        </div>
        <WatchProducts />
